...
//        log.info("msg = " + msg);
//        Alert alertMessage = objectMapper.readValue(msg, Alert.class);
//        WebSocketSession sendedPushSession = userSessionMap.get(alertMessage.getAlert_id());//로그인 상태일때 알람 보냄
...
//        if (alertMessage.getT_unit().equals(Alert.MessageType.SEND)) {
//            log.info("JSON이라서 등장");
